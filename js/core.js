...
window.onload = function () {
  ...
  window.addEventListener('scroll', function () {
    if (window.pageYOffset > hHeight) {
      header.className.indexOf('sticky') > 0 ? '' : header.className += ' sticky';
    } else {
  ...
  menuToggle.onclick = function () {
    ...
    if (body.className.indexOf('mobile-menu-open') !== -1) {
      body.className = body.className.replace('mobile-menu-open', '');
    } else {
      body.className += ' mobile-menu-open';
    }
  };
